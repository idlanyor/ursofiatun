        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="dataSantriTable" class="table table-sm align-middle table-striped table-hover table-bordered">
                        <thead>
                            <tr>
                ...
                <form id="importForm" action="{{ route('santri.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control form-control-sm" id="file" name="file" accept=".xlsx,.xls"
                                required>
                        </div>

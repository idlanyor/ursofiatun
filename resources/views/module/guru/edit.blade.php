            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control form-control-sm" name="tempat_lahir" id="editTempatLahir"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control form-control-sm" name="tanggal_lahir" id="editTanggalLahir"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control form-control-sm" name="telepon" id="editTelepon"
                                    placeholder="Telepon">
